...
export const PrimaryButton: FC<IButton> = ({ text, state }) => {
  return (
    <motion.button
      ...
      className="customTransition py-[12px] px-[16px] w-full md:w-[202px] space-x-[8px] font-semibold text-sm md:text-base rounded-[10px] flex flex-1 md:flex-auto justify-center items-center text-white bg-primary hover:bg-primary-dark"
    >
